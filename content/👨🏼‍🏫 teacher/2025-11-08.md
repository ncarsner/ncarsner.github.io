...
<li>creating dynamic arrays <i>(before dynamic arrays existed natively)</i>,
<li>extracting strings <i>(before textsplit, textbefore, and textafter existed)</i>
<li>finding conditional minimum or maximum values within ranges <i>(before MINIFS and MAXIFS functions existed)</i>
<li>returning a dynamic array given a fixed reference point <i>(before # allowed a dynamic array to be detected automatically)</i>
<br><br>
